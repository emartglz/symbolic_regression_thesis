...
\begin{align*}
    \{  (0.0 & , \quad (700.0, \; 300.0, \; 0.0), \quad (-59.43, \; 31.0, \; 28.43))                \\
    (0.07    & , \quad (695.84, \; 302.17, \; 1.99), \quad (-69.5, \; 36.17, \; 33.33))             \\
    (0.13    & , \quad (691.67, \; 304.34, \; 3.99), \quad (-59.57, \; 30.71, \; 28.86))            \\
    (0.2     & , \quad (687.5, \; 306.49, \; 6.01), \quad (-69.5, \; 35.83, \; 33.83))              \\
    (0.26    & , \quad (683.33, \; 308.64, \; 8.04), \quad (-59.71, \; 30.43, \; 29.14))            \\
    (0.33    & , \quad (679.15, \; 310.77, \; 10.08), \quad (-59.71, \; 30.29, \; 29.43))       \},
\end{align*}
...
Al resolver el sistema de ecuaciones sobredeterminado se obtienen los parámetros $a_{I_1}$ = 0.00053658 y $a_{I_2}$ = 0.26386037. Este método se aplica para encontrar los parámetros de cada una de las ecuaciones del sistema y así se obtienen todos los parámetros del sistema.
