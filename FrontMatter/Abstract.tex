\begin{abstract}
    ...
    \textbf{Palabras claves:} Sistema de ecuaciones diferenciales lineales con respecto a los parámetros, Regresión simbólica, Algoritmo genético
